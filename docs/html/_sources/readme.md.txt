...
Use different cloud storage services, offering data storage flexibility
...
Secure your data by applying encryption to individual samples or chunks,
ensuring sensitive information is protected during storage.

This example demonstrates how to use the ``FernetEncryption`` class for
...
You can load the encrypted data using the ``StreamingDataset`` class as
follows:
...
If you want to implement your own encryption method, you can subclass
the ``Encryption`` class and define the necessary methods:
...
With this setup, you can ensure that your data remains secure while
maintaining flexibility in how you handle encryption.
...
\| # Files \| \|—|—|—|—|—\| \| PL Data \| **10:05 min** \| **00:30 min**
\| **143.1 GB** \| 2.339 \| \| Web Dataset \| 32:36 min \| 01:22 min \|
147.8 GB \| 1.144 \| \| Mosaic ML \| 49:49 min \| 01:04 min \| **143.1
GB** \| 2.298 \|
